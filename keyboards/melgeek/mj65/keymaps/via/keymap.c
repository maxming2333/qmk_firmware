...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_65_ansi( /* Base */
		    ...
		    KC_LCTL,   KC_LGUI,  KC_LALT,                      KC_SPC,                                 KC_MENU,  MO(1),    MO(2),  KC_LEFT, KC_DOWN,   KC_RIGHT
	),
	[1] = LAYOUT_65_ansi( /* FN */
			_______,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_F13,   KC_F14,
			_______,   RGB_TOG,  _______,  RGB_HUI,  RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD,  RGB_MOD,  _______,  _______,  _______,  _______,  KC_HOME,
            _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_SPI,  RGB_SPD,  _______,  _______,  _______,             KC_END,
